...
Stream evidence.txt in 50k-row chunks. Filter reverse hits, contaminants, PEP greater than or equal to 0.99, and multi-protein rows. Join peptides.txt for per-protein start positions. Label every S/T/Y site Positive (annotated ph) or Negative.
